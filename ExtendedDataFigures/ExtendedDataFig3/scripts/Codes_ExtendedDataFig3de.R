# ====================================================================
# Extended Data Fig. 3: Detected genes in RPE1 midS samples (continue)
# ====================================================================
...
# --- Extended Data Fig. 3de ---

# Load data
# Load lncATLAS_all_data_RCI (downloaded from https://lncatlas.crg.eu/ [Get Raw Data > RCI]; then converted to tabdelim format)
localization <- read.delim("/Volumes/scRR-seq_GEO/codes/ExtendedDataFig3/data/2025-04-22_lncATLAS_all_data_RCI_tab.txt")
...
onlyramda <- read.delim("/Volumes/scRR-seq_GEO/codes/ExtendedDataFig3/data/RPE1_06_Genes_detected_onlyinRamDA.txt")
both <- read.delim("/Volumes/scRR-seq_GEO/codes/ExtendedDataFig3/data/RPE1_06_Genes_detected_Both.txt")
