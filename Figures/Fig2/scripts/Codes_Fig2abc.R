...
df <- read.delim("/Volumes/scRR-seq_GEO/codes/Fig2/data/scRNAsvsBulk_tpm_mouse_8cell_embryo.txt")
...
# Load RSEM TPM data
rsem_iso <- read.delim("/Volumes/scRR-seq_GEO/codes/Fig1/data/scRR-seq-RNA_8cell_mouse_transcripts_genes_rsem_selectedsamples_TPM_mm10.txt")
rsem_gene <- read.delim("/Volumes/scRR-seq_GEO/codes/Fig1/data/scRR-seq-RNA_8cell_mouse_genes_rsem_selectedsamples_TPM_mm10.txt")
...
shared <- gene_sets
upset(fromList(shared), order.by = "freq")
