...
rpe1_marker <- read.delim("/Volumes/scRR-seq_GEO/codes/ExtendedDataFig6/data/rpe1_dtClust_name.txt")
cbms1_marker <- read.delim("/Volumes/scRR-seq_GEO/codes/ExtendedDataFig6/data/CBMS1_dtClust_name.txt")
