...
repliscores <- read.delim("/Volumes/scRR-seq_GEO/codes/SupplementaryFig11/data/04_scRR-seq-DNA_RPE1_wholeS_pctreplicationscore_selectedsamples_all_hg38.txt")
...
#
write.table(df_plot_melt, "/Volumes/scRR-seq_GEO/source_data/source_data_fig4/fig4c_expression_ratio_autosomes.txt",
...
#
write.table(df_plot_melt_chrX, "/Volumes/scRR-seq_GEO/source_data/source_data_fig4/fig4b_expression_ratio_chrX.txt",
            sep = "\t", quote = F, col.names = T, row.names = F)
