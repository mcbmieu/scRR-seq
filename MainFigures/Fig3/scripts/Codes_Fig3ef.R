...
#
write.table(cc.seurat_sort, "/Volumes/scRR-seq_GEO/source_data/source_data_fig3/fig3e_RPE1.txt",
...
#
write.table(cc.seurat_sort, "/Volumes/scRR-seq_GEO/source_data/source_data_fig3/fig3f_CBMS1.txt",
            sep = "\t", quote = F, col.names = T, row.names = F)
