# ==========================================================================
# Supplementary Fig. 7: Sample correlation of mouse 8-cell embryo samples
# ==========================================================================
...
# --- Supplementary Fig. 7a: Sample correlation of mouse 8-cell embryo samples ---

# Load count data
data <- read.delim("/Volumes/scRR-seq_GEO/codes/SupplementaryFig7/data/merged_featureCounts_allgene_8cellembryos_scRNAsvsBulk.txt")
...
# --- Supplementary Fig. 7d: Detection of histone and non-poly(A) genes in mouse 8-cell embryo samples ---

# Load histone gene data (TPM)
histone_df <- read.delim("/Volumes/scRR-seq_GEO/codes/SupplementaryFig7/data/merged_featureCounts_allgene_TPM_8cellembryos_scRNAsvsBulk_histone.txt")
...
data <- read.delim("/Volumes/scRR-seq_GEO/codes/SupplementaryFig7/data/merged_featureCounts_allgene_TPM_8cellembryos_scRNAsvsBulk.txt")
