# ===============================================================
# Supplementary Fig. 11b: New S-phase progression markers for RPE1
# ===============================================================
...
# Load scRR-RNA data
rpe1 = read.delim("/Volumes/scRR-seq_GEO/codes/SupplementaryFig11/data/04_scRR-seq-RNA_RPE1_wholeS_genes_rsem_selectedsamples_TPM_hg38.txt")
...
cellanno <- read.delim("/Volumes/scRR-seq_GEO/codes/SupplementaryFig11/data/04_scRR-seq-DNA_RPE1_wholeS_pctreplicationscore_selectedsamples_all_hg38.txt")
...
outdir="/Volumes/scRR-seq_GEO/codes/SupplementaryFig11/data"
...
# Define File paths
dtRes <- read.table("/Volumes/scRR-seq_GEO/codes/SupplementaryFig11/data/rpe1_fit_gam.txt", header = T)
dtRes2 <- read.table("/Volumes/scRR-seq_GEO/codes/SupplementaryFig11/data/rpe1_fittedValues.txt.gz", header = T)
