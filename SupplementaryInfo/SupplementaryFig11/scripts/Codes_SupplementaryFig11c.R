# ================================================================
# Supplementary Fig. 11c: New S-phase progression markers for CBMS1
# ================================================================
...
# Load scRR-RNA data
cbms1 = read.delim("E/Volumes/scRR-seq_GEO/codes/SupplementaryFig11/data/03_scRR-seq-RNA_CBMS1_mESC_genes_rsem_selectedsamples_TPM_mm10.txt")
rownames(cbms1) <- cbms1$Gene.id
cbms1$Gene.id <- NULL

# Load scRR-RNA data's annotation
cellanno <- read.delim("E/Volumes/scRR-seq_GEO/codes/SupplementaryFig11/data/03_scRR-seq-DNA_CBMS1_mESC_pctreplicationscore_selectedsamples_all_mm10.txt")
...
outdir="E/Volumes/scRR-seq_GEO/codes/SupplementaryFig11/data"
...
# Define File paths
dtRes <- read.table("E/Volumes/scRR-seq_GEO/codes/SupplementaryFig11/data/CBMS1_fit_gam.txt", header = T)
dtRes2 <- read.table("E/Volumes/scRR-seq_GEO/codes/SupplementaryFig11/data/CBMS1_fittedValues.txt.gz", header = T)
