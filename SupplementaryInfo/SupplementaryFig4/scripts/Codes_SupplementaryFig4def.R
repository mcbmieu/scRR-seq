# =====================================================================
# Supplementary Fig. 4: Correlation, PCA, and tSNE of RPE1 midS samples
# =====================================================================

# --- Supplementary Fig. 4d: Sample correlation by edgeR ---
...
data <- read.delim("/Volumes/scRR-seq_GEO/codes/SupplementaryFig4/data/merged_featureCounts_allgene_RPE1midS.txt")
